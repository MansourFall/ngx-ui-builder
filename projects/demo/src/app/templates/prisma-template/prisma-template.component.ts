...
@Component({
  ...
  templateUrl: './prisma-template.component.html',
  styleUrls: ['./prisma-template.component.scss']
})
export class PrismaTemplateComponent implements OnInit {
  ...
  getPageConfig(): ComponentConfig[] {
    const localConfig = localStorage.getItem('config') ?? JSON.stringify(landingPageConfig);
